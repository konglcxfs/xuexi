...
export type ProfileTraitCategory = 'cognitive_style' | 'emotion_pattern' | 'knowledge_gap' | 'pace_habit' | 'communication_pref' | 'motivation' | 'other';
/**
...
export interface ProfileTrait {
    ...
    category: ProfileTraitCategory | 'cognitive_style' | 'emotion_pattern' | 'knowledge_gap' | 'pace_habit' | 'communication_pref' | 'motivation' | 'other';
    content: string;
    /** 证据强度 0-1，多次佐证后会升高 */
    confidence: number;
    /** 支撑这条 trait 的证据数 */
...
export type LessonSceneKind = 'daily' | 'textbook' | 'graph' | 'exam' | 'chat';
